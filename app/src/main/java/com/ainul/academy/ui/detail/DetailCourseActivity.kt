    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (extras != null) {
            ...
            if (courseId != null) {
                ...
                activityDetailCourseBinding.progressBarMAin.visibility = View.VISIBLE
                ...
                viewModel.getModules().observe(this, Observer<List<ModuleEntity>>{ modules ->
                    activityDetailCourseBinding.progressBarMAin.visibility = View.INVISIBLE
                    activityDetailCourseBinding.content.visibility = View.VISIBLE

                    adapter.setModules(modules)
                    adapter.notifyDataSetChanged()
                })
                viewModel.getCourse().observe(this,  Observer<CourseEntity>{ course -> populateCourse(course) })
