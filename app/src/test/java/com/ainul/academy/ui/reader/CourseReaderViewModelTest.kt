...
class CourseReaderViewModelTest {
    ...
    fun setUp() {
        ...
        val dummyModulez = dummyModules[0]
        dummyModulez.content = ContentEntity("<h3 class=\\\"fr-text-bordered\\\">"+dummyModulez.title+"</h3><p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>")
    }
    ...
    fun getSelectedModule() {
        ...
        val contentEntity = moduleEntity.content
        assertNotNull(contentEntity)
        val content = contentEntity?.content
        assertNotNull(content)
        assertEquals(content, dummyModules[0].content?.content)
    }
}